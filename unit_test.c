...
void dispatcher_logic(void *arguments) {
    ...
    sleep(2); //wait for 5 sec. Important to test for multiple threads
    if (count > 0) {
...
int main(int argc, char *argv[]) {
    ...
    if (test_no == 1){
        if (0 == strcmp("server", argv[1])) {
            ...
            threadN = 4;
            lim_memory.rlim_cur = 1000*(long unsigned)100000;
            ...
            start_server_socket("./cs303_sock", 10);
        }
        else  send_message_to_socket("/lib/x86_64-linux-gnu/libm.so.6 cos 2", "./cs303_sock");
    }
    ...
    // ---------UNIT TEST 3----------------
        ...
        else  send_message_to_socket("hello cos 2", "./cs303_sock");
    }
    ...
    if (test_no == 4){
        ...
        else  send_message_to_socket("/lib/x86_64-linux-gnu/libm.so.6 hello 2", "./cs303_sock");
    }
    ...
    if (test_no == 5){
        ...
        else  send_message_to_socket("/lib/x86_64-linux-gnu/libm.so.6 sin 2", "./cs303_sock");
    }
    ...
    if (test_no == 6){
        ...
        else  send_message_to_socket("/lib/x86_64-linux-gnu/libm.so.6 tan 2", "./cs303_sock");
    }
    ...
    if (test_no == 7){
        ...
        else  send_message_to_socket("/lib/x86_64-linux-gnu/libm.so.6 abs 2", "./cs303_sock");
    }
